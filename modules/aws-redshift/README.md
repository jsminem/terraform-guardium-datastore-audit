...
| gdp_ssh_username | SSH username for the Guardium Data Protection server | string | - | yes |
| gdp_ssh_privatekeypath | Path to the SSH private key for the Guardium Data Protection server | string | - | yes |
