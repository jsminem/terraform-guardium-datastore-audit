...
|------|-------------|------|---------|
| db_host | The hostname of the RDS PostgreSQL instance | string | - |
| db_username | The master username for the RDS PostgreSQL instance | string | - |
| db_password | The master password for the RDS PostgreSQL instance | string | - |
...
| db_port | The port of the RDS PostgreSQL instance | number | 5432 |
| db_name | The database to connect to | string | "postgres" |
| udc_name | Name for universal connector | string | "documentdb-gdp" |
