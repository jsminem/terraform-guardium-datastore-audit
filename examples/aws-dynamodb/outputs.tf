...
#----------------------------------------
output "profile_csv" {
  value       = module.dynamodb_uc.profile_csv
  description = "Content of the profile CSV"
}

output "udc_name" {
  value       = module.dynamodb_uc.udc_name
...
output "cloudwatch_log_group_name" {
  value       = module.dynamodb_uc.cloudwatch_log_group_name
  description = "Name of the CloudWatch Log Group"
}

output "cloudwatch_log_group_arn" {
  value       = module.dynamodb_uc.cloudwatch_log_group_arn
  description = "ARN of the CloudWatch Log Group"
}

output "formatted_cloudwatch_logs_group_arn" {
  value       = module.dynamodb_uc.formatted_cloudwatch_logs_group_arn
  description = "Formatted ARN of the CloudWatch Log Group for CloudTrail"
}

output "cloudtrail_name" {
  value       = module.dynamodb_uc.cloudtrail_name
  description = "Name of the CloudTrail"
}

output "cloudtrail_s3_bucket" {
  value       = module.dynamodb_uc.cloudtrail_s3_bucket
  description = "Name of the S3 bucket for CloudTrail logs"
}

output "iam_role_arn" {
  value       = module.dynamodb_uc.iam_role_arn
